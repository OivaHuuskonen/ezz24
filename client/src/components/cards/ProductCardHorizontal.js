...
export default function ProductCardHorizontal({ p, remove = false, onRemove }) {
        ...
        <div className="d-flex justify-content-between">
          ...
          {remove && (
            <p
              ...
              onClick={() => {
                console.log("Remove button clicked for product ID:", p._id); // Debug
                onRemove ? onRemove(p._id) : removeFromCart(p._id);
              }}
            >
              Remove
            </p>
  ...
  return (
    <div className="card mb-3">
      ...
      {remove && (
        <p
          className="text-danger mb-2 pointer"
          onClick={() => onRemove ? onRemove(p._id) : removeFromCart(p._id)}
        >
          Remove
        </p>
      )}
